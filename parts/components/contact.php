<!-- contact -->
<section id="contact-section" class="bg-primary-600 w-full flex flex-col py-12">
    <?php
    if ($args['_with_load'])
    ...
    <!-- contact/email -->
    <div class="flex-grow flex flex-col md:flex-row justify-center items-center gap-8 md:gap-24 transition-all">
            ...
            <div id="_contact_hidden_wrapper" class="text">
                <div id="_contact_hidden_form" class="flex flex-col gap-4">
                    ...
                    <div class="w-full flex gap-2">
                        ...
                        <label for="age_confirm">* Ao enviar esse formulário, você confirma ter 18 anos ou mais.</label>
                    </div>
                    <div class="w-full flex gap-2">
